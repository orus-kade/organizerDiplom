 ...
 */
@Stateless
@Path("ru.sfedu.organizer.model.human")
public class HumanFacadeREST extends AbstractFacade<Human> {

    @PersistenceContext(unitName = "ru.sfedu_organizer_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    public HumanFacadeREST() {
        super(Human.class);
    }
    ...
    public Human find(@PathParam("id") Long id) {
